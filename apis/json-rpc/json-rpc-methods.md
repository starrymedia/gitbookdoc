...
| ----------------------------------------------------------------------------------------------------- | --------- | ----------- | ------ | ------------------ |
| [`web3_clientVersion`](json-rpc-methods.md#web3\_clientversion)                                       | Web3      | ✔           | ✔      |                    |
| [`web3_sha3`](json-rpc-methods.md#web3\_sha3)                                                         | Web3      | ✔           | ✔      |                    |
| [`net_version`](json-rpc-methods.md#net\_version)                                                     | Net       | ✔           | ✔      |                    |
| [`net_peerCount`](json-rpc-methods.md#net\_peercount)                                                 | Net       | ✔           | ✔      |                    |
| [`net_listening`](json-rpc-methods.md#net\_listening)                                                 | Net       | ✔           | ✔      |                    |
| [`eth_protocolVersion`](json-rpc-methods.md#eth\_protocolversion)                                     | Eth       | ✔           | ✔      |                    |
| [`eth_syncing`](json-rpc-methods.md#eth\_syncing)                                                     | Eth       | ✔           | ✔      |                    |
| [`eth_gasPrice`](json-rpc-methods.md#eth\_gasprice)                                                   | Eth       | ✔           | ✔      |                    |
| [`eth_accounts`](json-rpc-methods.md#eth\_accounts)                                                   | Eth       | ✔           | ✔      |                    |
| [`eth_blockNumber`](json-rpc-methods.md#eth\_blocknumber)                                             | Eth       | ✔           | ✔      |                    |
| [`eth_getBalance`](json-rpc-methods.md#eth\_getbalance)                                               | Eth       | ✔           | ✔      |                    |
| [`eth_getStorageAt`](json-rpc-methods.md#eth\_getstorageat)                                           | Eth       | ✔           | ✔      |                    |
| [`eth_getTransactionCount`](json-rpc-methods.md#eth\_gettransactioncount)                             | Eth       | ✔           | ✔      |                    |
| [`eth_getBlockTransactionCountByNumber`](json-rpc-methods.md#eth\_getblocktransactioncountbynumber)   | Eth       | ✔           | ✔      |                    |
| [`eth_getBlockTransactionCountByHash`](json-rpc-methods.md#eth\_getblocktransactioncountbyhash)       | Eth       | ✔           | ✔      |                    |
| [`eth_getCode`](json-rpc-methods.md#eth\_getcode)                                                     | Eth       | ✔           | ✔      |                    |
| [`eth_sign`](json-rpc-methods.md#eth\_sign)                                                           | Eth       | ✔           | ✔      |                    |
| [`eth_sendTransaction`](json-rpc-methods.md#eth\_sendtransaction)                                     | Eth       | ✔           | ✔      |                    |
| [`eth_sendRawTransaction`](json-rpc-methods.md#eth\_sendrawtransaction)                               | Eth       | ✔           | ✔      |                    |
| [`eth_call`](json-rpc-methods.md#eth\_call)                                                           | Eth       | ✔           | ✔      |                    |
| [`eth_estimateGas`](json-rpc-methods.md#eth\_estimategas)                                             | Eth       | ✔           | ✔      |                    |
| [`eth_getBlockByNumber`](json-rpc-methods.md#eth\_getblockbynumber)                                   | Eth       | ✔           | ✔      |                    |
| [`eth_getBlockByHash`](json-rpc-methods.md#eth\_getblockbyhash)                                       | Eth       | ✔           | ✔      |                    |
| [`eth_getTransactionByHash`](json-rpc-methods.md#eth\_gettransactionbyhash)                           | Eth       | ✔           | ✔      |                    |
| [`eth_getTransactionByBlockHashAndIndex`](json-rpc-methods.md#eth\_gettransactionbyblockhashandindex) | Eth       | ✔           | ✔      |                    |
| [`eth_getTransactionReceipt`](json-rpc-methods.md#eth\_gettransactionreceipt)                         | Eth       | ✔           | ✔      |                    |
| [`eth_newFilter`](json-rpc-methods.md#eth\_newfilter)                                                 | Eth       | ✔           | ✔      |                    |
| [`eth_newBlockFilter`](json-rpc-methods.md#eth\_newblockfilter)                                       | Eth       | ✔           | ✔      |                    |
| [`eth_newPendingTransactionFilter`](json-rpc-methods.md#eth\_newpendingtransactionfilter)             | Eth       | ✔           | ✔      |                    |
| [`eth_uninstallFilter`](json-rpc-methods.md#eth\_uninstallfilter)                                     | Eth       | ✔           | ✔      |                    |
| [`eth_getFilterChanges`](json-rpc-methods.md#eth\_getfilterchanges)                                   | Eth       | ✔           | ✔      |                    |
| [`eth_getFilterLogs`](json-rpc-methods.md#eth\_getfilterlogs)                                         | Eth       | ✔           | ✔      |                    |
| [`eth_getLogs`](json-rpc-methods.md#eth\_getlogs)                                                     | Eth       | ✔           | ✔      |                    |
...
| `eth_mining`                                                                                          | Eth       |             | ❌      |                    |
| [`eth_coinbase`](json-rpc-methods.md#eth\_coinbase)                                                   | Eth       | ✔           |        |                    |
...
| [`eth_getProof`](json-rpc-methods.md#eth\_getproof)                                                   | Eth       | ✔           |        |                    |
| [`eth_subscribe`](json-rpc-methods.md#eth\_subscribe)                                                 | Websocket | ✔           |        |                    |
| [`eth_unsubscribe`](json-rpc-methods.md#eth\_unsubscribe)                                             | Websocket | ✔           |        |                    |
| [`personal_importRawKey`](json-rpc-methods.md#personal\_importrawkey)                                 | Personal  | ✔           | ❌      |                    |
| [`personal_listAccounts`](json-rpc-methods.md#personal\_listaccounts)                                 | Personal  | ✔           | ❌      |                    |
| [`personal_lockAccount`](json-rpc-methods.md#personal\_lockaccount)                                   | Personal  | ✔           | ❌      |                    |
| [`personal_newAccount`](json-rpc-methods.md#personal\_newaccount)                                     | Personal  | ✔           | ❌      |                    |
| [`personal_unlockAccount`](json-rpc-methods.md#personal\_unlockaccount)                               | Personal  | ✔           | ❌      |                    |
| [`personal_sendTransaction`](json-rpc-methods.md#personal\_unlockaccount)                             | Personal  | ✔           | ❌      |                    |
| [`personal_sign`](json-rpc-methods.md#personal\_sign)                                                 | Personal  | ✔           | ❌      |                    |
| [`personal_ecRecover`](json-rpc-methods.md#personal\_ecrecover)                                       | Personal  | ✔           | ❌      |                    |
| [`personal_initializeWallet`](json-rpc-methods.md#personal\_initializewallet)                         | Personal  | ✔           | ❌      |                    |
| [`personal_unpair`](json-rpc-methods.md#personal\_unpair)                                             | Personal  | ✔           | ❌      |                    |
| `db_putString`                                                                                        | DB        |             |        |                    |
| `db_getString`                                                                                        | DB        |             |        |                    |
| `db_putHex`                                                                                           | DB        |             |        |                    |
| `db_getHex`                                                                                           | DB        |             |        |                    |
...
| [`debug_traceBlock`](json-rpc-methods.md#debug\_traceblockbynumber)                                   | Debug     | ✔           |        |                    |
| [`debug_traceBlockByNumber`](json-rpc-methods.md#debug\_traceblockbynumber)                           | Debug     | ✔           |        |                    |
| [`debug_traceBlockByHash`](json-rpc-methods.md#debug\_traceblockbynumber)                             | Debug     | ✔           |        |                    |
| `debug_traceBlockFromFile`                                                                            | Debug     |             |        |                    |
| `debug_standardTraceBlockToFile`                                                                      | Debug     |             |        |                    |
| `debug_standardTraceBadBlockToFile`                                                                   | Debug     |             |        |                    |
| [`debug_traceTransaction`](json-rpc-methods.md#debug\_tracetransaction)                               | Debug     | ✔           |        |                    |
...
| [`miner_getHashrate`](json-rpc-methods.md#miner\_gethashrate)                                         | Miner     | ✔           | ❌      | No-op              |
| [`miner_setExtra`](json-rpc-methods.md#miner\_setextra)                                               | Miner     | ✔           | ❌      | No-op              |
| [`miner_setGasPrice`](json-rpc-methods.md#miner\_setgasprice)                                         | Miner     | ✔           | ❌      | Needs node restart |
| [`miner_start`](json-rpc-methods.md#miner\_start)                                                     | Miner     | ✔           | ❌      | No-op              |
| [`miner_stop`](json-rpc-methods.md#miner\_stop)                                                       | Miner     | ✔           | ❌      | No-op              |
| [`miner_setGasLimit`](json-rpc-methods.md#miner\_setgaslimit)                                         | Miner     | ✔           | ❌      | No-op              |
| [`miner_setEtherbase`](json-rpc-methods.md#miner\_setetherbase)                                       | Miner     | ✔           | ❌      |                    |
| [`txpool_content`](json-rpc-methods.md#txpool\_content)                                               | TxPool    | ✔           |        |                    |
| [`txpool_inspect`](json-rpc-methods.md#txpool\_inspect)                                               | TxPool    | ✔           |        |                    |
|                                                                                                       | TxPool    | ✔           |        |                    |
...
Creates new message call transaction or a contract creation for signed transactions. You can get signed transaction data using the [`personal_sign`](broken-reference) method.
...
The account can be used with [`eth_sign`](json-rpc-methods.md#eth\_sign) and [`eth_sendTransaction`](json-rpc-methods.md#eth\_sendtransaction) while it is unlocked.
...
The transaction is the same argument as for [`eth_sendTransaction`](json-rpc-methods.md#eth\_sendtransaction) and contains the `from` address. If the passphrase can be used to decrypt the private key belonging to `tx.from` the transaction is verified, signed and send onto the network.
...
`ecRecover` returns the address associated with the private key that was used to calculate the signature in [`personal_sign`](json-rpc-methods.md#personal\_sign).

#### Parameters

* Message
* Signature returned from [`personal_sign`](json-rpc-methods.md#personal\_sign)
...
Make sure your `uptickd start` call is not using the flag `minimum-gas-prices` because this value will be used instead of the one set on the configuration file.
